...
%reponse impulsionnelle finie, filtre stable
%coupe proprement autres frequences, courbe de gain commence a 0 puis
%laisse passer 0.15Hz
%poles dans cercle unite, zeros sur cercle