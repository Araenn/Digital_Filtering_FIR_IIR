...
ylabel("Module")
%resonnance a 0.15 Hz, coupe frequence ailleurs
...
ylabel("Amplitude")
% filtre coupe frequence < 0.15, laisse passer une amplitude basse de la
% frequence sensee etre coupee, car filtre coupe certaine amplitude (pas 0)
figure(6)
plot(f, tftd_y)
grid()
